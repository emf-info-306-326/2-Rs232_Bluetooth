    ...
    public boolean open() {
        ...
        if (serialPort == null) {
            ...
            try {
                ...
                readThread = new ReadThread(instance, serialPort);
                readThread.start(); // Démarre le thread de lecture
                ok = true;
    ...
    public boolean close() {
        ...
        if (instance.serialPort != null) {
            try {
                ...
                try {
                    readThread.join(); // attend la fin du thread de lecture
                } catch (InterruptedException ex) {
                    System.out.println("Erreur lors du Join de fermeture");
                }
